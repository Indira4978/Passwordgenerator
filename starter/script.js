...
function generatePassword() {
  ...
  function randomPass() {
    ...
    if (numInPassword !== null) {
      characterList = characterList.concat(numbersInPassword);
    }
    //if lowerCase included then add lowerCasedCharacters in characterList, 
    if (isLower !== null){
      characterList = characterList.concat(lowerCasedCharacters);
    }
    //if Uppercase included then add upperCasedCharacters in characterList,
    if (isUpper !== null) {
      characterList = characterList.concat(upperCasedCharacters);
    }
